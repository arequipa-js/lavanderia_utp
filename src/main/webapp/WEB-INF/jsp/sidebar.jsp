...
<div class="sidebar">
  ...
  <a href="usuarios.html"><i class="bi bi-person-fill m-2"></i>Usuarios</a>
  <a href="categorias.html"><i class="bi bi-bookmark-fill m-2"></i>Categorias</a>
  <a href="servicios.html"><i class="bi bi-telephone-fill m-2"></i>Servicios</a>
  <a href="clientes.html"><i class="bi bi-person-lines-fill m-2"></i>Clientes</a>
  <a href="prendas.html"><i class="bi bi-p-square-fill m-2"></i>Prendas</a>
  <a href="movilidades.html"><i class="bi bi-car-front-fill m-2"></i>Movilidades</a>
